// Headless benchmark: upload fixtures/assembly-ascii.zip into the app and measure
...
const fixture = path.resolve(root, "fixtures", "assembly-ascii.zip");
...
async function main() {
  ...
  const tabs = await fetch("http://localhost:9359/json").then((r) => r.json());
