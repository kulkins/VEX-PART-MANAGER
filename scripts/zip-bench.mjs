// Headless benchmark: upload fixtures/assembly.zip into the app and measure
...
const fixture = path.resolve(root, "fixtures", "assembly.zip");
...
async function main() {
  ...
  const tabs = await fetch("http://localhost:9355/json").then((r) => r.json());
